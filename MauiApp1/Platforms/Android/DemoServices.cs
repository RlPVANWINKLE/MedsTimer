...
//namespace MedsTimer.Platforms.Android
//{
[Service]
public class nonStopServices : Service
{
    ...
    public void Start()
    {
        Intent startService = new Intent(MainActivity.ActivityCurrent, typeof(nonStopServices));
